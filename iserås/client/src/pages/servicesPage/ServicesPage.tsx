...
export default function ServicesPage() {
  return (
    <>
      <Helmet>
        <title>Tjänster | Iserås Kamin & Skorsten</title>
        <meta
          name="description"
          content="Läs mer om våra tjänster inom installation av kaminer, renovering av skorstenar och rådgivning. Iserås Kamin & Skorsten hjälper dig skapa en trygg och hållbar eldstadslösning."
        />
        <meta
          name="keywords"
          content="kamininstallation, renovering skorsten, installera kamin, skorsten renovering, rådgivning kamin, Iserås Kamin & Skorsten"
        />
        ...
        <section className="servicesPage__hero">
          <div className="servicesPage__container">
            ...
            <h1 className="servicesPage__title">
              Kamininstallation och renovering av skorsten
            </h1>
        ...
        <section className="servicesPage__list">
          <div className="servicesPage__container">
            {services.map((service, index) => (
              <article
                key={index}
                className={`servicesPage__service ${
                  service.reverse ? "servicesPage__service--reverse" : ""
                }`}
              >
          ...
          <div className="servicesPage__container servicesPage__ctaInner">
            <div>
              ...
              <p className="servicesPage__text servicesPage__ctaText">
                ...
                nästa steg för ditt projekt. Helt kostnadsfritt! Du kan också
                kontakta oss via{" "}
                <a

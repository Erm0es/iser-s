...
export default function AboutPage() {
  return (
    <>
      <Helmet>
        <title>Om oss | Iserås Kamin & Skorsten</title>
        <meta
          name="description"
          content="Lär känna Iserås Kamin & Skorsten och vårt arbete med installation av kaminer, renovering av skorstenar och personlig rådgivning i Västra Götaland."
        />
        <meta
          name="keywords"
          content="Iserås Kamin & Skorsten, om oss, kamininstallation, skorsten, skorstensrenovering, rådgivning, Västra Götaland"
        />
        ...
        <section className="about__hero">
          <div className="about__container">
            ...
            <p className="about__lead">
              Vi på Iserås Kamin och Skorsten arbetar med installation, renovering
          ...
          <div className="about__container about__grid">
            <div className="about__textBlock">
              <h2 className="about__sectionTitle">
                Ett personligt och noggrant arbetssätt
              </h2>
              <p className="about__text">
                Vi tror på noggrant utfört arbete, tydlig kommunikation och
                lösningar som håller över tid. Oavsett om det gäller en ny
                kamin, renovering av skorsten eller planering inför ett framtida
                projekt vill vi göra processen enkel och trygg för dig som kund.
              </p>
              <p className="about__text">
        ...
        <section className="about__values">
          <div className="about__container">
            <div className="about__sectionIntro">
              ...
              <h2 className="about__sectionTitle">
                Så vill vi att det ska kännas för dig att anlita Iserås!
              </h2>
            </div>
            ...
            <div className="about__cards">
              ...
              <article className="about__card">
                ...
                <p className="about__cardText">
                  Vi tror på nära dialog, tydlig rådgivning och ett bemötande
                  som känns enkelt, varmt och professionellt.
                </p>
              </article>
            </div>
          </div>
        ...
        <section className="about__cta">
          <div className="about__container about__ctaInner">
            <div>
              ...
              <h2 className="about__sectionTitle">
                Behöver du hjälp med kamin eller skorsten?
              </h2>
              <p className="about__text about__ctaText">
                Hör gärna av dig om du vill ha hjälp med rådgivning,
                installation eller renovering. Vi hjälper dig vidare från första
                tanke till färdigt resultat.
              </p>
            </div>

            <Link to="/kontakt" className="about__button">
              Kontakta oss
            </Link>
          </div>
        </section>
